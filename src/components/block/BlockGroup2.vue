  ...
  >
    <div class="flex items-center p-4">
      <input
        ...
        placeholder="name"
        type="text"
        class="h-8 rounded-md border border-input bg-background px-3 py-1.5 text-xs text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring shadow-2xs transition-colors"
