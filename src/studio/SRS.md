...
| `getTables(options)` / `addTable` / `deleteTable` | [`storage-service.js`](file:///c:/Users/pn.tund2/Documents/Repository/automa-ecosystem/automa-ext/src/studio/storage-service.js) | `/api/v1/storage/tables` | Quản lý bảng dữ liệu Global Storage, phân trang dữ liệu dòng (Rows). |
| `getVariables(options)` / `addVariable` / `deleteVariable` | [`storage-service.js`](file:///c:/Users/pn.tund2/Documents/Repository/automa-ecosystem/automa-ext/src/studio/storage-service.js) | `/api/v1/storage/variables` | Quản lý danh sách biến toàn cục (Key-Value pairs). |
| `getCredentials(options)` | [`storage-service.js`](file:///c:/Users/pn.tund2/Documents/Repository/automa-ecosystem/automa-ext/src/studio/storage-service.js) | `/api/v1/storage/credentials` | Lấy danh sách khóa bí mật mã hóa AES-256. |
